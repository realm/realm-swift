...
- (void)testGetSubtable
{
    ...
    STAssertThrows([table getSubtable:2 ndx:0 withClass:[WrongNameTable class]], @"should throw an exception because wrong name");
    STAssertThrows([table getSubtable:2 ndx:0 withClass:[WrongTypeTable class]], @"should throw an exception because wrong type");
}
