...
/**
 ...
 @return            Whether or not the schema of the Realm at `realmPath` matches the current schema.
 */
+ (BOOL)migrationRequiredAtPath:(NSString *)realmPath encryptionKey:(NSData *)key error:(NSError **)error;
