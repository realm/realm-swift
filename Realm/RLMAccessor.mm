...
template<>
realm::Mixed RLMStatelessAccessorContext::unbox(id, CreatePolicy, ObjKey) {
    REALM_UNREACHABLE();
}
template<>
...
template<>
realm::Obj RLMStatelessAccessorContext::unbox(__unsafe_unretained id const, CreatePolicy, ObjKey) {
    REALM_UNREACHABLE();
}
template<>
