...
typedef RLM_ERROR_ENUM(NSInteger, RLMSyncError, RLMSyncErrorDomain) {
    ...
    /**
     ...
     was backed up on the server. This file can be opened as a non-synchronized Realm by
     creating a Realm configuration, specifying the `fileURL`, and setting the property
     `openSyncedRealmOffline` to YES.
