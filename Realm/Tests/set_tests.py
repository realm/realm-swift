...
types = [
  ...
  ['AllPrimitiveSets', 'unmanaged', 'dateObj', ['date(1)', 'date(2)'], ['date(1)', 'date(3)'], ['r', 'minmax', 'unman']],
  ...
  ['AllPrimitiveSets', 'unmanaged', 'anyObjB', ['@2', '@3'], ['@2', '@3'], {'r', 'any', 'sum', 'avg', 'unman'}],
  ['AllPrimitiveSets', 'unmanaged', 'anyObjC', ['@2.2f', '@3.3f'], ['@2.2f', '@3.3f'], {'r', 'any', 'minmax', 'sum', 'avg', 'unman'}],
  ['AllPrimitiveSets', 'unmanaged', 'anyObjD', ['@2.2', '@3.3'], ['@2.2', '@3.3'], {'r', 'any', 'minmax', 'sum', 'avg', 'unman'}],
  ['AllPrimitiveSets', 'unmanaged', 'anyObjE', ['@"a"', '@"b"'], ['@"a"', '@"b"'], {'r', 'any', 'unman', 'string'}],
  ['AllPrimitiveSets', 'unmanaged', 'anyObjF', ['data(1)', 'data(2)'], ['data(1)', 'data(2)'], {'r', 'any', 'unman'}],
  ['AllPrimitiveSets', 'unmanaged', 'anyObjG', ['date(1)', 'date(2)'], ['date(1)', 'date(2)'], {'r', 'any', 'minmax', 'unman', 'date'}],
  ['AllPrimitiveSets', 'unmanaged', 'anyObjH', ['decimal128(2)', 'decimal128(3)'], ['decimal128(2)', 'decimal128(3)'], {'r', 'any', 'minmax', 'sum', 'avg', 'unman'}],
  ['AllPrimitiveSets', 'unmanaged', 'anyObjI', ['objectId(1)', 'objectId(2)'], ['objectId(1)', 'objectId(2)'], {'r', 'any', 'unman'}],
  ['AllPrimitiveSets', 'unmanaged', 'anyObjJ', ['uuid(@"00000000-0000-0000-0000-000000000000")', 'uuid(@"137DECC8-B300-4954-A233-F89909F4FD89")'], ['uuid(@"00000000-0000-0000-0000-000000000000")', 'uuid(@"137DECC8-B300-4954-A233-F89909F4FD89")'], ['r', 'any','unman']],
  ...
  ['AllOptionalPrimitiveSets', 'optUnmanaged', 'dateObj', ['NSNull.null', 'date(1)', 'date(2)'], ['date(2)', 'date(3)'], ['o', 'minmax', 'unman']],
  ...
  ['AllPrimitiveSets', 'managed', 'dateObj', ['date(1)', 'date(2)'], ['date(2)', 'date(3)'], ['r', 'minmax', 'man']],
  ...
  ['AllPrimitiveSets', 'managed', 'anyObjB', ['@2', '@3'], ['@2', '@3'], {'r', 'any', 'minmax', 'sum', 'avg', 'man'}],
  ['AllPrimitiveSets', 'managed', 'anyObjC', ['@2.2f', '@3.3f'], ['@2.2f', '@3.3f'], {'r', 'any', 'minmax', 'sum', 'avg', 'man'}],
  ['AllPrimitiveSets', 'managed', 'anyObjD', ['@2.2', '@3.3'], ['@2.2', '@3.3'], {'r', 'any', 'minmax', 'sum', 'avg', 'man'}],
  ['AllPrimitiveSets', 'managed', 'anyObjE', ['@"a"', '@"b"'], ['@"a"', '@"b"'], {'r', 'any', 'man', 'string'}],
  ['AllPrimitiveSets', 'managed', 'anyObjF', ['data(1)', 'data(2)'], ['data(1)', 'data(2)'], {'r', 'any', 'man'}],
  ['AllPrimitiveSets', 'managed', 'anyObjG', ['date(1)', 'date(2)'], ['date(1)', 'date(2)'], {'r', 'any', 'minmax', 'man', 'date'}],
  ['AllPrimitiveSets', 'managed', 'anyObjH', ['decimal128(2)', 'decimal128(3)'], ['decimal128(2)', 'decimal128(3)'], {'r', 'any', 'minmax', 'sum', 'avg', 'man'}],
  ['AllPrimitiveSets', 'managed', 'anyObjI', ['objectId(1)', 'objectId(2)'], ['objectId(1)', 'objectId(2)'], {'r', 'any', 'man'}],
  ['AllPrimitiveSets', 'managed', 'anyObjJ', ['uuid(@"00000000-0000-0000-0000-000000000000")', 'uuid(@"137DECC8-B300-4954-A233-F89909F4FD89")'], ['uuid(@"00000000-0000-0000-0000-000000000000")', 'uuid(@"137DECC8-B300-4954-A233-F89909F4FD89")'], ['r', 'any', 'man']],
  ...
  ['AllOptionalPrimitiveSets', 'optManaged', 'dateObj', ['NSNull.null', 'date(1)', 'date(2)'], ['date(2)', 'date(3)'], ['o', 'minmax', 'man']],
