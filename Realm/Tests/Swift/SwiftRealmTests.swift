...
class SwiftRealmTests: SwiftTestCase {
    ...
    func testRealmAddAndRemoveObjects() {
        ...
        XCTAssertEqual(SwiftStringObject.allObjectsInRealm(realm).count, Int(3), "Expecting 3 objects")
        realm.commitWriteTransaction()
        ...
        XCTAssertEqual(SwiftStringObject.allObjectsInRealm(realm).count, Int(1), "Expecting 1 object")
        realm.commitWriteTransaction()
    ...
    func testUpdatingSortedArrayAfterBackgroundUpdate() {
        ...
        let token = realm.addNotificationBlock() { (_, _) in
            ...
            XCTAssertEqual(objs.sortedResultsUsingProperty("intCol", ascending: true).count, Int(2))
    ...
    func testRealmAddAndRemoveObjects_objc() {
        ...
        XCTAssertEqual(StringObject.allObjectsInRealm(realm).count, Int(3), "Expecting 3 objects")
        realm.commitWriteTransaction()
        ...
        XCTAssertEqual(StringObject.allObjectsInRealm(realm).count, Int(1), "Expecting 1 object")
        realm.commitWriteTransaction()
