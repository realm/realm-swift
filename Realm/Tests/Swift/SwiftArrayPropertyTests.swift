...
class SwiftArrayPropertyTests: SwiftTestCase {
    ...
    func testBasicArray() {
        ...
        XCTAssertEqual(SwiftStringObject.allObjectsInRealm(realm).count, Int(1), "There should be a single SwiftStringObject in the realm")

        let array = SwiftArrayPropertyObject()
        array.name = "arrayObject"
        array.array.addObject(string)
        XCTAssertEqual(array.array.count, Int(1))
        ...
        XCTAssertEqual(arrayObjects.count, Int(1), "There should be a single SwiftStringObject in the realm")
    ...
    func testPopulateEmptyArray() {
        ...
        XCTAssertEqual(array.array.count, Int(0), "Should start with no array elements")
        ...
        XCTAssertEqual(array.array.count, Int(3), "Should have three elements in array")
    ...
    func testModifyDetatchedArray() {
        ...
        XCTAssertEqual(arObj.array.count, Int(0), "Should start with no array elements")
        ...
        XCTAssertEqual(array.count, Int(2), "Should have two elements in array")
    ...
    func testBasicArray_objc() {
        ...
        XCTAssertEqual(StringObject.allObjectsInRealm(realm).count, Int(1), "There should be a single StringObject in the realm")
        ...
        XCTAssertEqual(arrayObjects.count, Int(1), "There should be a single StringObject in the realm")
