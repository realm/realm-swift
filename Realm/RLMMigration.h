...
/**
 Create an RLMObject of type `className` during a migration in the Realm being migrated.
...
/**
 Delete an object from a Realm during a migration. This can be called withing `enumerateObjects:block:`.
