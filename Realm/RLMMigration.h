...
/**
 ...
 @param oldName   The old column name for the property to be renamed. There must not be a property with this name in the
                  class as defined by the new Realm schema.
 @param newName   The new column name for the property to be renamed. There must not be a property with this name in the
