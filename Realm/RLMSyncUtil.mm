...
NSString *const kRLMSyncRealmIDKey       = @"realm_id";
NSString *const kRLMSyncRealmURLKey      = @"realm_url";
NSString *const kRLMSyncPathKey          = @"path";
NSString *const kRLMSyncTokenKey         = @"token";
NSString *const kRLMSyncIdentityKey      = @"identity";
NSString *const kRLMSyncExpiresKey       = @"expires";
NSString *const kRLMSyncRefreshKey       = @"refresh";
