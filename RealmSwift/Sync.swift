...
public final class SyncPermissionOffer: Object {
    ...
    /**
     ...
     - parameter realmURL:  The URL to the Realm to offer permissions to.
     - parameter mayRead:   If set to `true`, grant read access.
     - parameter mayWrite:  If set to `true`, grant read-write access.
     - parameter mayManage: If set to `true`, grant administrative access.
     */
...
public final class SyncPermissionOfferResponse: Object {
    ...
    /// based on a SyncPermissionOffer.
    ...
    /**
     ...
     which was created by another user based on a RLMSyncPermissionOffer.
     - parameter token:  The received token.
     */
