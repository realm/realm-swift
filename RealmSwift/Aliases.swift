...
/// Protocol that allows Objects to be observed with full type safety.
public protocol _PartialKeyPathObservableObject {}
extension _PartialKeyPathObservableObject where Self: RLMObjectBase {
    /**
...
extension ObjectBase: _PartialKeyPathObservableObject {
    /**
     Registers a block to be called each time the object changes.
