...
public class BoundObject<T: Object> : ObservableObject {
...
@available(iOS 13.0, macOS 10.15, tvOS 13.0, watchOS 6.0, *)
@propertyWrapper
public struct BindObject<T: Object>: DynamicProperty {
    private var _wrappedValue: ObservedObject<BoundObject<T>>
    ...
    public var projectedValue: BoundObject<T> {
        return _wrappedValue.wrappedValue
    }
    var token: NotificationToken?

    public init(wrappedValue: T) {
        _wrappedValue = ObservedObject(wrappedValue: BoundObject(wrappedValue))
        token = wrappedValue.observe { [_wrappedValue] _ in
