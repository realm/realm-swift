...
extension Object: Combine.ObservableObject, Identifiable {
    public typealias ObjectWillChangePublisher = RealmObjectPublisher<Object>

    public var objectWillChange: RealmObjectPublisher<Object> {
        RealmObjectPublisher(self)
    }
