...
class Decimal128Tests: TestCase {
    ...
    func testDecimal128ComparisionLessThan() {
        let d1: Decimal128 = 3.14159
        let d2: Decimal128 = .init(number: NSNumber(floatLiteral: 3.14160))
