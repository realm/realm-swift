...
class SwiftObjectInterfaceTests: TestCase {
    ...
    func testSwiftObject() {
        ...
        let firstObj = Results(type: SwiftObject.self, realm: realm).first!
    ...
    func testMergedDefaultValuesSwiftObject() {
        ...
        let object = Results(type: SwiftDefaultObject.self, realm: realm).first
    ...
    func testOptionalSwiftProperties() {
        ...
        let firstObj = Results(type: SwiftOptionalObject.self, realm: realm).first!
