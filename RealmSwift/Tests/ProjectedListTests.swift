...
class ProjectedListTests: TestCase {
    ...
    func testSetValues() {
        ...
        let danyObject = realm.objects(CommonPerson.self).filter("lastName == 'Targaryen'").first!
    ...
    let expected = "ProjectedList<String><String> <ProjectedList<String>\\(backingList: List<CommonPerson> <0x[0-9a-f]+> \\(\n\t\\[0\\] CommonPerson \\{\n\t\tfirstName = Daenerys;\n\t\tlastName = Targaryen;\n\t\tbirthday = 1970-01-01 00:00:00 \\+0000;\n\t\taddress = AddressSwift \\{\n\t\t\tcity = King's Landing;\n\t\t\tcountry = Westeros;\n\t\t\\};\n\t\tfriends = List<CommonPerson> <0x[0-9a-f]+> \\(\n\t\t\t\\[0\\] CommonPerson \\{\n\t\t\t\tfirstName = John;\n\t\t\t\tlastName = Snow;\n\t\t\t\tbirthday = 1970-01-01 00:00:10 \\+0000;\n\t\t\t\taddress = AddressSwift \\{\n\t\t\t\t\tcity = Winterfell;\n\t\t\t\t\tcountry = Kingdom in the North;\n\t\t\t\t\\};\n\t\t\t\tfriends = List<CommonPerson> <0x[0-9a-f]+> \\(\n\t\t\t\t\t\\[0\\] <Maximum depth exceeded>,\n\t\t\t\t\t\\[1\\] <Maximum depth exceeded>\n\t\t\t\t\\);\n\t\t\t\treviews = List<string> <0x[0-9a-f]+> \\(\n\t\t\t\t\n\t\t\t\t\\);\n\t\t\t\tmoney = 2\\.22;\n\t\t\t\\}\n\t\t\\);\n\t\treviews = List<string> <0x[0-9a-f]+> \\(\n\t\t\n\t\t\\);\n\t\tmoney = 2\\.22;\n\t\\},\n\t\\[1\\] CommonPerson \\{\n\t\tfirstName = Tyrion;\n\t\tlastName = Lannister;\n\t\tbirthday = 1970-01-01 00:00:20 \\+0000;\n\t\taddress = AddressSwift \\{\n\t\t\tcity = Casterly Rock;\n\t\t\tcountry = Westeros;\n\t\t\\};\n\t\tfriends = List<CommonPerson> <0x[0-9a-f]+> \\(\n\t\t\n\t\t\\);\n\t\treviews = List<string> <0x[0-9a-f]+> \\(\n\t\t\n\t\t\\);\n\t\tmoney = 9999\\.95;\n\t\\}\n\\), keyPath: Swift\\.ReferenceWritableKeyPath<RealmSwift[_]?Tests\\.CommonPerson, Swift\\.String>, propertyName: \"firstName\", anyCtor: \\(Function\\)\\)> \\{\nProjectedList<CommonPerson> <0x[0-9a-f]+> \\(\n\t\\[0\\] CommonPerson \\{\n\t\tfirstName = Daenerys;\n\t\tlastName = Targaryen;\n\t\tbirthday = 1970-01-01 00:00:00 \\+0000;\n\t\taddress = AddressSwift \\{\n\t\t\tcity = King's Landing;\n\t\t\tcountry = Westeros;\n\t\t\\};\n\t\tfriends = List<CommonPerson> <0x[0-9a-f]+> \\(\n\t\t\t\\[0\\] CommonPerson \\{\n\t\t\t\tfirstName = John;\n\t\t\t\tlastName = Snow;\n\t\t\t\tbirthday = 1970-01-01 00:00:10 \\+0000;\n\t\t\t\taddress = AddressSwift \\{\n\t\t\t\t\tcity = Winterfell;\n\t\t\t\t\tcountry = Kingdom in the North;\n\t\t\t\t\\};\n\t\t\t\tfriends = List<CommonPerson> <0x[0-9a-f]+> \\(\n\t\t\t\t\t\\[0\\] <Maximum depth exceeded>,\n\t\t\t\t\t\\[1\\] <Maximum depth exceeded>\n\t\t\t\t\\);\n\t\t\t\treviews = List<string> <0x[0-9a-f]+> \\(\n\t\t\t\t\n\t\t\t\t\\);\n\t\t\t\tmoney = 2\\.22;\n\t\t\t\\}\n\t\t\\);\n\t\treviews = List<string> <0x[0-9a-f]+> \\(\n\t\t\n\t\t\\);\n\t\tmoney = 2\\.22;\n\t\\},\n\t\\[1\\] CommonPerson \\{\n\t\tfirstName = Tyrion;\n\t\tlastName = Lannister;\n\t\tbirthday = 1970-01-01 00:00:20 \\+0000;\n\t\taddress = AddressSwift \\{\n\t\t\tcity = Casterly Rock;\n\t\t\tcountry = Westeros;\n\t\t\\};\n\t\tfriends = List<CommonPerson> <0x[0-9a-f]+> \\(\n\t\t\n\t\t\\);\n\t\treviews = List<string> <0x[0-9a-f]+> \\(\n\t\t\n\t\t\\);\n\t\tmoney = 9999\\.95;\n\t\\}\n\\)\n\\}"
    ...
    func testObserveKeyPathNoChange() {
        ...
        dispatchSyncNewThread {
            ...
            realm.beginWrite()
            let obj = realm.objects(CommonPerson.self).first!
...
//        observeOnQueue(collection)
    ...
    func testThaw() {
        ...
        try! liveRealm.write { liveRealm.delete(liveRealm.objects(CommonPerson.self).filter(NSPredicate(format: "firstName != 'Daenerys'"))) }
