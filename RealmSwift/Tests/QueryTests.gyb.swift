...
class QueryTests: TestCase {
    ...
    func testSubquery() {
        ...
        assertQuery(predicate: "((((intCol == %@ && setInt.@count == %@) && SUBQUERY(setCol, $obj, ($obj.intCol == %@ || $obj.stringCol == %@)).@count == %@) && SUBQUERY(setCol, $obj, (($obj.intCol == %@ || $obj.stringCol == %@) || ($obj.intCol == %@ && $obj.stringCol == %@))).@count == %@) && SUBQUERY(setCol, $obj, $obj.stringCol == %@).@count == %@)", values: [6, 2, 5, "Foo", 1, "Bar", 0], expectedCount: 0) {
            $0.intCol == 6 &&
            $0.setInt.count() == 2 &&
            ($0.setCol.intCol == 5 || $0.setCol.stringCol == "Foo").count() == 1 &&
