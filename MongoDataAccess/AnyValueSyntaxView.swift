...
extension SyntaxView {
    private static func syntaxView(for json: String, at startIndex: String.Index, allowedObjectTypes: [any SyntaxView.Type]) -> any SyntaxView {
        ...
        if scanner.scanDouble() != nil {
            return DoubleLiteralSyntaxView(json: json, at: leadingIndex)
        }
        if scanner.scanInt() != nil {
            return IntLiteralSyntaxView(json: json, at: leadingIndex)
        }
        if scanner.scanString("true") != nil {
            return BoolSyntaxView(json: json, at: leadingIndex)
        }
...
public struct AnyValueSyntaxView<View : SyntaxView> : LiteralSyntaxView {
    ...
    public init(json: String, at startIndex: String.Index) throws {
        try self.init(json: json, at: startIndex, allowedObjectTypes: defaultSchema)
    }
    ...
    public init(json: String, 
        ...
        self.syntaxView = try View.init(json: json, at: startIndex, allowedObjectTypes: allowedObjectTypes)
...
//        }
        ...
        public init(json: String,
                    at startIndex: String.Index,
                    allowedObjectTypes: [any MongoDataAccess.SyntaxView.Type]) throws {
            self.rawJSON = json
            self.startIndex = startIndex
            ...
            self.rawObjectSyntaxView = RawObjectSyntaxView(json: json, at: startIndex, allowedObjectTypes: allowedObjectTypes)
        }
