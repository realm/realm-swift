...
let coreVersionStr = "12.5.1"
let cocoaVersionStr = "10.28.7"
...
let package = Package(
    ...
    dependencies: [
        .package(name: "RealmDatabase", url: "https://github.com/realm/realm-core", .revision("c4e3f87fe6a93171590462ad985b4974bb5a9c26"))
    ],
    targets: [
      .target(
            name: "Realm",
