...
- **Have a bug to report?** [Open an issue](https://github.com/realm/realm-cocoa/issues). If possible, include the version of Realm, a full log, the Realm file, and a project that shows the issue.
