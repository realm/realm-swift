...
- (void)testInsert {
    ...
    PerfTable *table = [group getTable:@"employees"withClass:[PerfTable class] error:nil];
...
- (void)testFetch
{
    ...
    PerfTable *diskTable = [fromDisk getTable:@"employees" withClass:[PerfTable class] error:nil];
