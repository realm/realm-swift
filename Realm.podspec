Pod::Spec.new do |s|
  ...
  s.pod_target_xcconfig     = { 'APPLICATION_EXTENSION_API_ONLY' => 'YES',
                                ...
                                'VALID_ARCHS[sdk=iphonesimulator*]' => 'x86_64 i386', # Required for Xcode 11.3
                                'VALID_ARCHS[sdk=watchsimulator*]' => 'x86_64 i386', # Required for Xcode 11.3
                                'VALID_ARCHS[sdk=appletvsimulator*]' => 'x86_64 i386', # Required for Xcode 11.3
                                'VALID_ARCHS[sdk=macosx*]' => 'x86_64 i386', # Required for Xcode 11.3
                              }
