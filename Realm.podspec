Pod::Spec.new do |s|
  ...
  # Compilation
  s.dependency             'RealmCore', `sed -n 's/^REALM_CORE_VERSION=\(.*\)$/\1/p' dependencies.list`
  s.dependency             'RealmSync', `sed -n 's/^REALM_SYNC_VERSION=\(.*\)$/\1/p' dependencies.list`
  s.libraries            = 'c++'
  ...
  s.public_header_files  = 'Realm/Realm.h',
                           ...
                           'Realm/RLMRealm+Server.h',
                           'Realm/RLMRealmConfiguration+Server.h',
                           'Realm/RLMServer.h',
                           'Realm/RLMServerUtil.h',
                           'Realm/RLMSessionInfo.h',
                           'Realm/RLMUser.h'
