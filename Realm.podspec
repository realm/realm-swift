...
Pod::Spec.new do |s|
  ...
  s.ios.vendored_library    = 'core/librealm-sync-ios.a'

  s.osx.deployment_target   = '10.9'
  s.osx.vendored_library    = 'core/librealm-sync--macosx.a'

  s.watchos.deployment_target = '2.0'
  s.watchos.vendored_library  = 'core/librealm-sync-watchos.a'

  s.tvos.deployment_target = '9.0'
  s.tvos.vendored_library  = 'core/librealm-sync-tvos.a'
