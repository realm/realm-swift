...
- (IBAction)generatedTestDb:(id)sender
{
    ...
    RealmTestClass1 *tc1_0 = [RealmTestClass1 instanceWithInt:10    bool:YES float:123.456 double:123456.789 string:@"ten"      date:[NSDate date]                                                      arrayRef:ta_0];
    RealmTestClass1 *tc1_1 = [RealmTestClass1 instanceWithInt:20    bool:NO  float:23.4561 double:987654.321 string:@"twenty"   date:[NSDate distantPast]                                               arrayRef:ta_1];
    RealmTestClass1 *tc1_2 = [RealmTestClass1 instanceWithInt:30    bool:YES float:3.45612 double:1234.56789 string:@"thirty"   date:[NSDate distantFuture]                                             arrayRef:ta_2];
    RealmTestClass1 *tc1_3 = [RealmTestClass1 instanceWithInt:40    bool:NO  float:.456123 double:9876.54321 string:@"fourty"   date:[[NSDate date] dateByAddingTimeInterval:-60.0 * 60.0 * 24.0 * 7.0] arrayRef:ta_3];
    RealmTestClass1 *tc1_4 = [RealmTestClass1 instanceWithInt:50    bool:YES float:654.321 double:123.456789 string:@"fifty"    date:[[NSDate date] dateByAddingTimeInterval:+60.0 * 60.0 * 24.0 * 7.0] arrayRef:ta_4];
    RealmTestClass1 *tc1_5 = [RealmTestClass1 instanceWithInt:60    bool:NO  float:6543.21 double:987.654321 string:@"sixty"    date:[[NSDate date] dateByAddingTimeInterval:-60.0 * 60.0 * 24.0 * 1.0] arrayRef:ta_5];
    RealmTestClass1 *tc1_6 = [RealmTestClass1 instanceWithInt:70    bool:YES float:65432.1 double:12.3456789 string:@"seventy"  date:[[NSDate date] dateByAddingTimeInterval:+60.0 * 60.0 * 24.0 * 1.0] arrayRef:ta_6];
    RealmTestClass1 *tc1_7 = [RealmTestClass1 instanceWithInt:80    bool:NO  float:654321. double:98.7654321 string:@"eighty"   date:[[NSDate date] dateByAddingTimeInterval:-60.0 * 60.0 * 12.0 * 1.0] arrayRef:ta_7];
    RealmTestClass1 *tc1_8 = [RealmTestClass1 instanceWithInt:90    bool:YES float:123.456 double:1.23456789 string:@"ninety"   date:[[NSDate date] dateByAddingTimeInterval:+60.0 * 60.0 * 12.0 * 1.0] arrayRef:ta_8];
    RealmTestClass1 *tc1_9 = [RealmTestClass1 instanceWithInt:100   bool:NO  float:123.456 double:9.87654321 string:@"hundred"  date:[[NSDate date] dateByAddingTimeInterval:+60.0 *  5.0 *  1.0 * 1.0] arrayRef:ta_9];
