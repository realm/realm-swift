...
public final class Migration {
    ...
    */
    ...
    /**
    Renames the class in the underlying database file from the original name to the new name. The new
    class's properties must be identical to the old class.

    - parameter originalName: The name of the original object class to rename.
    - parameter newName:      The new name of the object class after renaming.
