...
class ObjectSchemaTests: TestCase {
    ...
    func testObjectIDProperty() {
        let objectSchema = swiftObjectSchema
        XCTAssertNil(objectSchema.objectIDProperty)
        XCTAssertEqual(try! Realm().schema["SwiftPrimaryStringObject"]!.objectIDProperty!.name, "stringCol")
    }
